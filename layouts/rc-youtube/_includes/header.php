<header class="bar bar-nav bar-light bg-white pr-0 bar-top-shadow" data-snap-ignore="true">
...
<nav class="bar bar-tab bg-faded bg-white shadow" data-snap-ignore="true">
  <a class="tab-item active" role="button" data-tab="main">
    <span class="icon material-icons">house</span>
    <span class="tab-label">홈</span>
  </a>
  <a class="tab-item" role="button" data-tab="best" data-sort="hit" data-d_start="<?php echo date("Ymd", strtotime("-1 week")) ?>">
    <span class="icon material-icons">whatshot</span>
    <span class="tab-label">인기</span>
  </a>
  <a class="tab-item" role="button" data-tab="feed">
    <span class="icon material-icons">subscriptions</span>
    <span class="tab-label">구독</span>
  </a>
  <a class="tab-item" role="button" data-tab="noti">
  ...
  <a class="tab-item" role="button" data-tab="libary">
